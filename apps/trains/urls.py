...
urlpatterns = [
    ...
    path('ui/', views.train_operations_dashboard_view, name='dashboard'),
    path('ui/live-status/', views.train_operations_dashboard_view, name='live_status'),
    path('ui/htmx/simulate-delay/', views.htmx_simulate_delay_view, name='htmx_simulate_delay'),
    path('ui/<str:train_number>/detail/', views.train_detail_view, name='detail'),
]

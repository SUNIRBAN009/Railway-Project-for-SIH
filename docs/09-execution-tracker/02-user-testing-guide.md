...
## ৭. Phase 1: Identity, Security & RBAC (TSK-P1-01-BE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ৮. Phase 1: Frontend Authentication & Persona Switcher (TSK-P1-01-FE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ৯. Phase 1: E2E Login ও Role-Based Route Guarding (TSK-P1-01-TEST) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১০. Phase 1: Current User Context & Operational Capabilities (TSK-P1-02-BE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১১. Phase 1: Context-Aware ProtectedRoutes & Smart Redirect (TSK-P1-02-FE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১২. Phase 1: Multi-Department Routing Verification (TSK-P1-02-TEST) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১৩. Phase 2: PostGIS GeoJSON Corridor & BlockSection (TSK-P2-01-BE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১৪. Phase 2: 3D Perspective Mapbox Canvas 45° Tilt (TSK-P2-01-FE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১৫. Phase 2: 3D Pitch Mapbox Canvas ও PostGIS Track Geometry (TSK-P2-01-TEST) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১৬. Phase 2: Block Model & Proposal Submission API (TSK-P2-02-BE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১৭. Phase 2: Multi-Step Possession Request Form Wizard (TSK-P2-02-FE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১৮. Phase 2: E2E Frontend Block Proposal Submission ও Database Persistence (TSK-P2-02-TEST) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ১৯. Phase 2: Spatial-Temporal Sweep-Line Conflict Engine & AI Combined Block (TSK-P2-03-BE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
- **Step 10:** টেস্ট চলাকালীন সৃষ্ট ব্লকগুলো স্বয়ংক্রিয়ভাবে বাতিল করে ক্লিন স্টেট রক্ষা।
...
## ২০. Phase 2: Interactive Gantt Deconfliction ও AI Combined Block Card (TSK-P2-03-FE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ২১. Phase 2: Scenario B E2E Overlapping Blocks & AI Synergy (TSK-P2-03-TEST) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ২২. Phase 2: Chief Controller Sanctioning ও Optimistic Concurrency Locking (TSK-P2-04-BE) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ২৩. Phase 2: COA কমান্ড কনসোল ও ওয়ান-ক্লিক স্যাংশনিং ইউজার ইন্টারফেস (`TSK-P2-04-FE`) ✅ **[VERIFIED & TESTED]**
...
## ২৪. Phase 2: COA অনুমোদন, অপটিমিস্টিক লকিং ও কনকারেন্সি টেস্ট স্যুট (`TSK-P2-04-TEST`) ✅ **[VERIFIED & TESTED]**
...
## ২৫. Phase 2: ট্রেন মাস্টার সময়সূচি, লাইভ রানিং অবস্থান ও ১২টি মাস্টার ট্রেনের COA ইনজেশন (`TSK-P2-05-BE`) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ২৬. Phase 2: ৬০ FPS লাইভ ট্রেন ট্র্যাকিং মার্কার, স্পিড ব্যাজ ও ম্যাপ সিমুলেশন কন্ট্রোলস (`TSK-P2-05-FE`) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ২৭. Phase 2: ৬০ FPS ট্রেন ট্র্যাকিং ও কাইনেমেটিক সিমুলেশন স্বয়ংক্রিয় ভেরিফিকেশন (`TSK-P2-05-TEST`) টেস্ট নির্দেশিকা ✅ **[VERIFIED & TESTED]**
...
## ২৮. Phase 2: গ্যাং ও হেভি ইকুইপমেন্ট রোস্টার এবং রুল ৩ এক্সক্লুসিভিটি টেস্ট নির্দেশিকা (`TSK-P2-06`) ✅ **[VERIFIED & TESTED]**
...
## ২৯. Phase 3: Daphne ASGI Channels ও Redis Pub/Sub রিয়েল-টাইম পুশ-টু-ইনভ্যালিডেট টেস্ট নির্দেশিকা (`TSK-P3-01-BE`) ✅ **[VERIFIED & TESTED]**
...
## ৩০. Phase 3: অ্যাসেট কন্ডিশন, CoF × LoF ৫×৫ রিস্ক ম্যাট্রিক্স, এজিং স্কোর ও ইমার্জেন্সি ব্লক ভেরিফিকেশন (`TSK-P3-02-BE`) ✅ **[VERIFIED & TESTED]**
...
## ৩১. Phase 3: ফ্রন্টএন্ড ৫×৫ রিস্ক ম্যাট্রিক্স, ম্যাপবক্স ডিফেক্ট হিটম্যাপ ও "Why #1?" এআই এক্সপ্ল্যানেশন কার্ড ভেরিফিকেশন (`TSK-P3-02-FE` & `TSK-P3-02-TEST`) ✅ **[VERIFIED & TESTED]**
...
## ৩২. Phase 3: ক্যাটাগরিক্যাল রেল ফ্র্যাকচার ওয়েবসকেট `EMERGENCY_ALERT` ব্রডকাস্ট ভেরিফিকেশন (`TSK-P3-03-BE`) ✅ **[VERIFIED & TESTED]**
...
## ৩৩. Phase 3: ফুল-স্ক্রিন এমার্জেন্সি কনটেইনমেন্ট মোডাল ও ওয়েব অডিও এপিআই সাইরেন ভেরিফিকেশন (`TSK-P3-03-FE` & `TSK-P3-03-TEST`) ✅ **[VERIFIED & TESTED]**
...
## ৩৪. ইউজার টেস্টিং গাইড: ডিলে ক্যাসকেড রিক্যালকুলেটর ও HermiT DL ওএইচই হ্যাজার্ড রিজনার (`TSK-P3-04-BE`) ✅ **[VERIFIED & TESTED]**
...
## ৩৫. ইউজার টেস্টিং গাইড: ডিলে ক্যাসকেড রিপল ম্যাট্রিক্স ও সেমান্টিক হ্যাজার্ড প্রুফ UI (`TSK-P3-04-FE`) ✅ **[VERIFIED & TESTED]**
...
## ৩৬. ইউজার টেস্টিং গাইড: সিনারিও সি (Scenario C) এক্সিকিউশন, ডিলে রিপল ক্যাসকেড ও ২৫kV OHE স্যাংশন ব্লকার E2E টেস্টিং (`TSK-P3-04-TEST`) ✅ **[VERIFIED & TESTED]**
...
## ৩৭. ইউজার টেস্টিং গাইড: দৈনিক OLAP অ্যাগ্রিগেশন — পাঙ্কচুয়ালিটি, ব্লক কাউন্ট, শ্যাডো ব্লক বান্ডলিং রেশিও ও TQI স্কোর (`TSK-P4-01-BE`) ✅ **[VERIFIED & TESTED]**
...
## ৩৮. ইউজার টেস্টিং গাইড: বিগ স্ক্রিন ওয়ালবোর্ড ড্যাশবোর্ড, ৪K ডিসপ্লে অপ্টিমাইজেশন ও লাইভ KPI কাউন্টার (`TSK-P4-01-FE`) ✅ **[VERIFIED & TESTED]**
...
## ৩৯. ইউজার টেস্টিং গাইড: ডেমো ডেটা সিডিং ও ৪K ওয়ালবোর্ড ডায়নামিক OLAP লাইভ কাউন্টার E2E টেস্ট (`TSK-P4-01-TEST`) ✅ **[VERIFIED & TESTED]**
...
## ৪০. ইউজার টেস্টিং গাইড: অফিসিয়াল ব্লক স্যাংশন অর্ডার ও করিডোর বুলেটিন PDF ইঞ্জিন (`TSK-P4-02-BE`) ✅ **[VERIFIED & TESTED]**
...
## ৪১. ইউজার টেস্টিং গাইড: ফ্রন্টএন্ডে ওয়ান-ক্লিক "Download Corridor Report" বাটন ও PDF এক্সপোর্ট ইন্টিগ্রেশন (`TSK-P4-02-FE`) ✅ **[VERIFIED & TESTED]**
...
## ৪২. ইউজার টেস্টিং গাইড: এন্ড-টু-এন্ড PDF ডাউনলোড ও কারেন্ট টেবুলার ডাটা ভেরিফিকেশন (`TSK-P4-02-TEST`) ✅ **[VERIFIED & TESTED]**
...
## ৪৩. ইউজার টেস্টিং গাইড: k6 লোড টেস্টিং (১,০০০ ভার্চুয়াল ইউজার) ও Bandit AST সিকিউরিটি অডিট (`TSK-P4-03-BE`) ✅ **[VERIFIED & TESTED]**
...
## ৪৪. ইউজার টেস্টিং গাইড: ফ্রন্টএন্ড Vite প্রোডাকশন বিল্ড ও জিরো এরর অডিট (`TSK-P4-03-FE`) ✅ **[VERIFIED & TESTED]**
...
## ৪৫. ইউজার টেস্টিং গাইড: সিস্টেম রেসপন্সিভনেস (<৫০ms p95) ও এন্ড-টু-এন্ড সিকিউরিটি অডিট (`TSK-P4-03-TEST`) ✅ **[VERIFIED & TESTED]**
...
## ৪৬. ইউজার টেস্টিং গাইড: প্রেজেন্টেশন সিনারিও A "Morning Dashboard" (`TSK-FINAL-01`) ✅ **[VERIFIED & TESTED]**

### ৪৬.১ সিনারিওর মূল উদ্দেশ্য ও বিচারকদের সামনে উপস্থাপনার রূপরেখা
স্মার্ট ইন্ডিয়া হ্যাকাথন (SIH PS 26027) গ্র্যান্ড ফিনালেতে বিচারকদের সামনে প্ল্যাটফর্মের প্রথম ইমপ্রেশন তৈরি করার জন্য এই সিনারিওটি ডিজাইন করা হয়েছে:
১. **চিফ সেকশন কন্ট্রোলার কমান্ড রুম ইনিশিয়ালাইজেশন:**
   - চিফ কন্ট্রোলার (`coa_delhi_chief`) লগইন করার সাথে সাথে নয়াদিল্লি থেকে কানপুর সেন্ট্রাল পর্যন্ত ৪৪০.২ কিলোমিটার দীর্ঘ গোল্ডেন করিডোরের ৩D GIS রাডার ও লাইভ অপারেশনস ড্যাশবোর্ড লোড হয়।
২. **লাইভ ট্রেন ও শিডিউল মেইনটেন্যান্স ব্লক ভিজ্যুয়ালাইজেশন:**
   - ট্র্যাকে ১২টি সক্রিয় ট্রেনের লাইভ গতিবিধি এবং সিভিল ইঞ্জিনিয়ারিং (ENG), ইলেকট্রিক্যাল OHE (TRD) ও সিগন্যালিং (S&T) বিভাগের পরিকল্পিত ব্লকগুলো দৃশ্যমান হয়।
৩. **এআই ট্র্যাক ডিফেক্ট ডিটেকশন ও "Why #1?" এক্সপ্লেইনেবিলিটি কার্ড (#৯৪):**
   - ৫১টি ট্র্যাক অ্যাসেট স্ক্যান করে এআই সিস্টেম KM 144.200-এ একটি বিপজ্জনক আল্ট্রাসনিক রেল ফ্র্যাকচার (Transverse Fissure) শনাক্ত করে।
   - বিচারকদের দেখানোর জন্য প্ল্যাটফর্ম তাৎক্ষণিক **"Why #1?" Explainable AI Card** উপস্থাপন করে, যেখানে Consequence of Failure (CoF 0.95) × Likelihood of Failure (LoF 0.92) = 0.88 সূচক ও রাজধানী এক্সপ্রেসের মতো প্রিমিয়াম ট্রেনের সুরক্ষার যৌক্তিক কারণ ব্যাখ্যা করা হয়।
৪. **অটোমেটেড ইমার্জেন্সি ব্লক ও করিডোর সিঙ্ক্রোনাইজেশন:**
   - প্ল্যাটফর্ম নিজে থেকেই ২ ঘণ্টার জরুরি রেল রিনিউয়াল ব্লক (`BLK-EMG-NDLS-144`) প্রস্তাব করে এবং সমস্ত কন্ট্রোলার ও ডিসপ্লে প্যানেলে লাইভ সতর্কতা ব্রডকাস্ট করে।

---

### ৪৬.২ স্বয়ংক্রিয় এন্ড-টু-এন্ড টেস্ট চালান (Automated Verification)

টার্মিনাল বা PowerShell থেকে নিচের সহজ কমান্ডটি চালান:

```powershell
python scripts/test_final_01.py
```

#### টেস্ট স্ক্রিপ্ট যেভাবে ৮টি ধাপ স্বয়ংক্রিয়ভাবে যাচাই করে:
1. **ধাপ ১ (Chief Controller Authentication):** চিফ সেকশন কন্ট্রোলারের কেন্দ্রীয় কর্তৃত্ব ও JWT Bearer টোকেন যাচাই।
2. **ধাপ ২ (Corridor 3D GIS Radar Map):** ৪৪০.২ কিমি ট্র্যাক লাইনস্ট্রিং, ৬টি মূল স্টেশন (NDLS, GZB, ALJN, TDL, ETW, CNB) এবং ৫১টি অ্যাসেট যাচাই।
3. **ধাপ ৩ (Live Kinematic Trains Telemetry):** লাইভ গতি ও রিয়েল-টাইম কিমি পজিশন সহ ১২টি প্রধান ট্রেনের উপস্থিতি পরীক্ষা।
4. **ধাপ ৪ (Scheduled Blocks Audit):** সিভিল, ট্র্যাকশন ও সিগন্যাল বিভাগের শিডিউলকৃত রক্ষণাবেক্ষণ ব্লকের উপস্থিতি যাচাই।
5. **ধাপ ৫ ("Why #1?" Risk Card #94):** এক্সট্রিম রিস্ক ক্যাটাগরি ও এআই রেশনালের গাণিতিক প্রমাণপত্র নিশ্চিতকরণ।
6. **ধাপ ৬ (Scenario A REST Execution):** `POST /api/v1/demo/scenarios/run/` এর মাধ্যমে সিনারিওর ৫টি পর্যায়ক্রমিক স্টেপ নির্বাহ।
7. **ধাপ ৭ (Database Emergency Block):** ডাটাবেজে `BLK-EMG-NDLS-144` ব্লকের অস্তিত্ব ও পারসিসটেন্স অডিট।
8. **ধাপ ৮ (Frontend Scenario Player Integration):** ফ্রন্টএন্ডের `ScenarioPlayerModal.tsx` মডালে সিনারিও প্লেয়ার ও কন্ট্রোল ইন্টিগ্রেশন যাচাই।

---

### ৪৬.৩ ওয়েব ব্রাউজারে লাইভ ডেমো উপস্থাপনার নিয়ম (Presentation Flow)

১. **চিফ কন্ট্রোলার হিসেবে লগইন করুন:**
   - ব্রাউজারে যান: `http://localhost:3000/login`
   - ইউজারনেম: `coa_delhi_chief` | পাসওয়ার্ড: `railway@123`
২. **সেন্ট্রাল কন্ট্রোল ড্যাশবোর্ড দেখুন:**
   - ৩D করিডোর ম্যাপে ট্রেনের গতিবিধি এবং লাইভ স্টেশনের অবস্থান পর্যবেক্ষণ করুন।
৩. **সিনারিও প্লেয়ার চালু করুন:**
   - স্ক্রিনের শীর্ষে বা সাইডবারে **"Run Demo Scenario"** বাটনে ক্লিক করুন।
   - **"Scenario A: Morning Dashboard"** নির্বাচন করে **"Play Scenario"** বাটনে ক্লিক করুন।
৪. **এআই "Why #1?" কার্ড প্রদর্শন করুন:**
   - স্টেপ ৩-এ এআই কার্ড পপ-আপ হলে বিচারকদের সামনে CoF এবং LoF-এর গাণিতিক বিশ্লেষণ তুলে ধরুন।

---

## ৪৭. ইউজার টেস্টিং গাইড: প্রেজেন্টেশন সিনারিও B "Conflict -> Combined Block USP" (`TSK-FINAL-02`) ✅ **[VERIFIED & TESTED]**

### ৪৭.১ সিনারিওর মূল উদ্দেশ্য ও বিচারকদের সামনে উপস্থাপনার রূপরেখা
এই প্রেজেন্টেশন সিনারিওটি প্ল্যাটফর্মের সবচেয়ে বড় উদ্ভাবনী শক্তি এবং গেম-চেঞ্জিং ফিচার **USP #98 (AI Combined Shadow Bundling)** সরাসরি প্রমাণ করার জন্য তৈরি:
১. **বিভাগীয় ব্লক সাবমিশন ও রিয়েল কনফ্লিক্ট সৃষ্টি:**
   - ট্র্যাক ইঞ্জিনিয়ারিং (ENG) হেভি ট্যাম্পিং মেশিনের জন্য KM 142.500 থেকে 146.200 পর্যন্ত ভোর ০২:০০ থেকে ০৬:০০ পর্যন্ত ৪ ঘণ্টার ব্লকের প্রস্তাব জমা দেয়।
   - ঠিক একই রুটে ইলেকট্রিক্যাল OHE বিভাগ (TRD) তার টাওয়ার ওয়াগনের জন্য KM 143.000 থেকে 145.500 পর্যন্ত ভোর ০৩:০০ থেকে ০৭:০০ পর্যন্ত ৪ ঘণ্টার ব্লকের প্রস্তাব জমা দেয়।
২. **এআই সুইপ-লাইন কনফ্লিক্ট ইঞ্জিন ডিটেকশন:**
   - এআই অ্যালগরিদম তাৎক্ষণিকভাবে ২.৫০০ কিলোমিটার স্থানিক ওভারল্যাপ (Spatial Overlap) এবং ৩.০ ঘণ্টা সময়গত সংঘর্ষ (Temporal Overlap) শনাক্ত করে এবং উভয় ব্লককে `CONFLICT_DETECTED` স্ট্যাটাসে চিহ্নিত করে।
   - সাধারণত এটি ঘটার ফলে লাইন মোট ৫ ঘণ্টা বন্ধ থাকতো এবং ব্যাপক ট্রেন ডিলে তৈরি হতো।
৩. **এআই কম্বাইন্ড ব্লক রিকমেন্ডেশন (USP #98):**
   - প্ল্যাটফর্মের এআই সিনার্জি ইঞ্জিন গণনা করে দেখায় যে উভয় বিভাগকে একটি একক পাওয়ার ব্লকের (25kV OHE Isolation) আওতায় ভোর ০২:৩০ থেকে ০৬:৩০ পর্যন্ত ৪ ঘণ্টার সম্মিলিত ব্লকে সিঙ্ক্রোনাইজ করা সম্ভব।
   - এর ফলে সরাসরি **৩.৫ ঘণ্টা করিডোর ক্যাপাসিটি সাশ্রয় হয়**, রাজধানী এক্সপ্রেস সহ দূরপাল্লার ট্রেনের **১৪০ মিনিটের বিলম্ব প্রতিরোধ হয়**, এবং ট্র্যাক ব্যবহারে **+৮৭.৫% এফিসিয়েন্সি** তৈরি হয়।
৪. **১-ক্লিক স্যাংশন ও সিড্যাক SMS গেটওয়ে ডিসপ্যাচ:**
   - চিফ কন্ট্রোলার ওয়ান-ক্লিকে সম্মিলিত ব্লক `BLK-COMB-98-01` এবং ডিজিটাল কশন অর্ডার `CO-2026-DLI-98` ইস্যু করেন।
   - সাথে সাথে সিভিল ট্র্যাক ও ইলেকট্রিক্যাল উভয় গ্যাং-এর সিনিয়র সেকশন ইঞ্জিনিয়ারদের মোবাইলে রিয়েল-টাইম SMS নোটিফিকেশন পৌঁছে যায়।

---

### ৪৭.২ স্বয়ংক্রিয় এন্ড-টু-এন্ড টেস্ট চালান (Automated Verification)

টার্মিনাল বা PowerShell থেকে নিচের সহজ কমান্ডটি চালান:

```powershell
python scripts/test_final_02.py
```

#### টেস্ট স্ক্রিপ্ট যেভাবে ৮টি ধাপ স্বয়ংক্রিয়ভাবে যাচাই করে:
1. **ধাপ ১ (Chief Controller Authentication):** চিফ কন্ট্রোলার ক্রেডেনশিয়ালস ও সেন্ট্রাল কমান্ড অথরিটির যাচাই।
2. **ধাপ ২ (Scenario B REST API Run):** `POST /api/v1/demo/scenarios/run/` এর মাধ্যমে সিনারিও B এর ৫টি ধাপ নিখুঁতভাবে নির্বাহ।
3. **ধাপ ৩ (Conflict Overlap Geometry):** স্থানিক ২.৫ কিমি এবং সময়গত ৩.০ ঘণ্টা সংঘর্ষের গাণিতিক অডিট।
4. **ধাপ ৪ (Database Conflict States):** ডাটাবেজে `BLK-SCEN-ENG-142` এবং `BLK-SCEN-TRD-143` ব্লকের `CONFLICT_DETECTED` স্ট্যাটাস নিশ্চিতকরণ।
5. **ধাপ ৫ (Sanctioned Combined Block Persistence):** ডাটাবেজে সম্মিলিত ব্লক `BLK-COMB-98-01` এবং কশন অর্ডার `CO-2026-DLI-98` এর উপস্থিতি পরীক্ষা।
6. **ধাপ ৬ (CDAC SMS Delivery Logs):** ইঞ্জিনিয়ারিং ও ইলেকট্রিক্যাল গ্যাংদের কাছে প্রেরিত SMS গেটওয়ে লগ (`CDAC-SMS-ENG-9801`, `CDAC-SMS-TRD-9802`) অডিট।
7. **ধাপ ৭ (USP #98 Dividend Calculation):** ৩.৫ ঘণ্টা ক্যাপাসিটি সাশ্রয় ও ১৪০ মিনিট ট্রেন বিলম্ব প্রতিরোধের গাণিতিক যাচাই।
8. **ধাপ ৮ (Frontend Presentation Contract):** `ScenarioPlayerModal.tsx` এবং `CombinedBlockCard.tsx` কম্পোনেন্টে সিনারিও B এবং এআই কার্ডের রেন্ডারিং কন্ট্রাক্ট অডিট।

---

### ৪৭.৩ ওয়েব ব্রাউজারে বিচারকদের সামনে লাইভ ডেমো উপস্থাপনার নিয়ম (Presentation Flow)

১. **চিফ কন্ট্রোলার হিসেবে লগইন করুন:**
   - ব্রাউজারে যান: `http://localhost:3000/login`
   - ইউজারনেম: `coa_delhi_chief` | পাসওয়ার্ড: `railway@123`
২. **সিনারিও প্লেয়ার চালু করুন:**
   - সাইডবারে বা হেডারে **"Run Demo Scenario"** বাটনে ক্লিক করুন।
   - লিস্ট থেকে **"Scenario B: Combined Block (USP #98)"** সিলেক্ট করুন।
৩. **ধাপ ৪ ও ৫-এ বিশেষ নজর দিন:**
   - **ধাপ ৪:** স্ক্রিনে সাইবার-রেলওয়ে স্টাইলে **AI Combined Block Card** ভেসে উঠবে। বিচারকদের ৩.৫ ঘণ্টা সময় সাশ্রয় এবং ১৪০ মিনিট প্যাসেঞ্জার ট্রেন বিলম্ব প্রতিরোধের হিসাবটি দেখান।
   - **ধাপ ৫:** **"1-Click Sanction"** কার্যকর হলে ডিজিটাল কশন অর্ডার `CO-2026-DLI-98` তৈরি এবং গ্যাংদের মোবাইলে প্রেরিত SMS লগের তাৎক্ষণিক ডেলিভারি ডেমো দেখান।

---

## ৪৮. ইউজার টেস্টিং গাইড: প্রেজেন্টেশন সিনারিও C "Live Disruption & Breathing Plan" (`TSK-FINAL-03`) ✅ **[VERIFIED & TESTED]**

### ৪৮.১ সিনারিওর মূল উদ্দেশ্য ও বিচারকদের সামনে উপস্থাপনার রূপরেখা
বাস্তব রেলওয়ে অপারেশনে প্রতিদিন কোনো না কোনো ট্রেন অপ্রত্যাশিতভাবে বিলম্বে চলে। এই সিনারিওটি প্রমাণ করে কিভাবে প্ল্যাটফর্মের **Delay Cascade Recalculator (#115)** এবং **Dynamic Breathing Plan** এআই অ্যালগরিদম লাইভ ট্রেন লেটকে সামলিয়ে করিডোরের সময়ানুবর্তিতা (Punctuality) রক্ষা করে:
১. **লাইভ ট্রেন টেলিমেট্রি ডিসরাপশন শনাক্তকরণ:**
   - জিপিএস লাইভ ফিড শনাক্ত করে যে দূরপাল্লার ভিআইপি ট্রেন ১২৪২৪ ডিব্রুগড় রাজধানী এক্সপ্রেস নর্থ সেন্ট্রাল রেলওয়ের যানজটের কারণে ৪৫ মিনিট বিলম্বে চলছে এবং কানপুর সেন্ট্রালের দিকে এগিয়ে আসছে (KM 312.4, গতি 118 কিমি/ঘণ্টা)।
২. **শিডিউল ডেভিয়েশন ডিটেকশন (#১১৬):**
   - প্ল্যাটফর্মের স্বয়ংক্রিয় ইঞ্জিন (`DEV-2026-TRN-12424`) সতর্কবার্তা দেয় যে রাজধানী এক্সপ্রেসের নতুন সংশোধিত আগমন সময় KM 315.0-এ নির্ধারিত ইঞ্জিনিয়ারিং ট্র্যাক ট্যাম্পিং ব্লক `BLK-ENG-CNB-05`-এর সাথে সরাসরি সংঘাত তৈরি করছে (বাফার -৩০ মিনিট)।
৩. **রিপল ইমপ্যাক্ট ও ক্যাসকেড গণনা (#১১৫):**
   - HermiT ডেসক্রিপশন লজিক এবং সুইপ-লাইন ইঞ্জিন গণনা করে দেখায় যে ব্লকটি যদি মূল সময়ে বলবৎ থাকে, তবে পেছনের ৩টি সুপারফাস্ট প্যাসেঞ্জার ট্রেন (১২০০৪ শতাব্দী, ১২২৮০ তাজ এক্সপ্রেস, ২২৪৩৬ বন্দে ভারত) মোট ১৮৫ মিনিট বিলম্বের শিকার হবে!
৪. **এআই ডাইনামিক ব্রিদিং প্ল্যান উইন্ডো শিফট:**
   - সিস্টেম ব্লকের সময়কে স্বয়ংক্রিয়ভাবে +৪৫ মিনিট পিছিয়ে দেয় (০২:৩০ এর বদলে ০৩:১৫ থেকে ০৬:১৫ IST)। ফলে রাজধানী এক্সপ্রেস কোনো গতি নিয়ন্ত্রণ ছাড়াই পূর্ণ ১৩০ কিমি/ঘণ্টা গতিতে সেকশন পার হয়ে যায়।
   - করিডোরের প্যাসেঞ্জার পাঙ্কচুয়ালিটি ইনডেক্স **৯৯.২% অক্ষুণ্ণ থাকে** এবং গ্রাফিক্যাল গ্যান্ট চার্ট লাইভ রিসিঙ্ক্রোনাইজ হয়।
৫. **ফিল্ড গ্যাংদের স্বয়ংক্রিয় SMS অ্যালার্ট প্রেরণ:**
   - সিভিল ইঞ্জিনিয়ারিং গ্যাং ০৩-এর সুপারভাইজার রাম সিং-এর মোবাইলে সিড্যাক SMS গেটওয়ের মাধ্যমে তাৎক্ষণিক বার্তা পৌঁছায়: *"Block BLK-ENG-CNB-05 shifted to 03:15 IST. Standby on siding."*

---

### ৪৮.২ স্বয়ংক্রিয় এন্ড-টু-এন্ড টেস্ট চালান (Automated Verification)

টার্মিনাল বা PowerShell থেকে নিচের কমান্ডটি চালান:

```powershell
python scripts/test_final_03.py
```

#### টেস্ট স্ক্রিপ্ট যেভাবে ৮টি ধাপ স্বয়ংক্রিয়ভাবে যাচাই করে:
1. **ধাপ ১ (Chief Controller Authentication):** চিফ সেকশন কন্ট্রোলারের কেন্দ্রীয় কমান্ড যাচাই।
2. **ধাপ ২ (Scenario C REST Execution):** `POST /api/v1/demo/scenarios/run/` এর মাধ্যমে সিনারিওর ৫টি ধাপ সফলভাবে সম্পাদন।
3. **ধাপ ৩ (Schedule Deviation Detector #116):** ১২৪২৪ রাজধানী ট্রেনের ৪৫ মিনিট বিলম্ব ও ঋণাত্মক বাফার (-৩০ মিনিট) শনাক্তকরণ অডিট।
4. **ধাপ ৪ (Delay Cascade Recalculator #115):** শতাব্দী, তাজ ও বন্দে ভারত ট্রেনের সম্মিলিত ১৮৫ মিনিট বিলম্বের রিপল পূর্বাভাস যাচাই।
5. **ধাপ ৫ (Breathing Plan Database Persistence):** ডাটাবেজে `BLK-ENG-CNB-05` ব্লকের স্টার্ট ও এন্ড টাইম +৪৫ মিনিট পিছিয়ে যাওয়া ও ভার্সন বৃদ্ধি (v4) পরীক্ষা।
6. **ধাপ ৬ (Field Gang SMS Dispatch Logs):** গ্যাং ০৩ সুপারভাইজারের কাছে প্রেরিত CDAC SMS গেটওয়ে ডেলিভারি লগ (`CDAC-SMS-GANG-03`) যাচাই।
7. **ধাপ ৭ (Punctuality Dividend Calculation):** ৯৯.২% সময়ানুবর্তিতা অক্ষুণ্ণ থাকা এবং গ্যান্ট রিসিঙ্ক্রোনাইজেশন নিশ্চিতকরণ।
8. **ধাপ ৮ (Frontend Modal Presentation Contract):** `ScenarioPlayerModal.tsx`-এ সিনারিও C এর অডিও সংকেত, ক্যামেরা ফোকাস ও লাইভ HUD কন্ট্রাক্ট অডিট।

---

### ৪৮.৩ ওয়েব ব্রাউজারে বিচারকদের সামনে লাইভ ডেমো উপস্থাপনার নিয়ম (Presentation Flow)

১. **চিফ কন্ট্রোলার হিসেবে লগইন করুন:**
   - ব্রাউজারে যান: `http://localhost:3000/login`
   - ইউজারনেম: `coa_delhi_chief` | পাসওয়ার্ড: `railway@123`
২. **সিনারিও প্লেয়ার চালু করুন:**
   - হেডারে **"Run Demo Scenario"** বা **🎬 চিত্রনাট্য প্লেয়ার** বাটনে ক্লিক করুন।
   - **"Scenario C: Delay Cascade"** (ট্যাগ: *Breathing Plan*) সিলেক্ট করে **"Play Scenario"** বাটনে ক্লিক করুন।
৩. **ধাপ ৩ ও ৪-এ বিশেষ নজর দিন:**
   - **ধাপ ৩:** ৩টি ট্রেনের ১৮৫ মিনিটের ক্যাসকেডিং ডিলে অ্যানালাইসিস বিচারকদের দেখান।
   - **ধাপ ৪:** ব্রিদিং প্ল্যান কিভাবে ব্লককে +৪৫ মিনিট সরিয়ে দিয়ে রাজধানী এক্সপ্রেসকে সম্পূর্ণ গতিতে পার করিয়ে দিল এবং সময়ানুবর্তিতা ৯৯.২% ধরে রাখলো তা বিস্তারিত ব্যাখ্যা করুন।
   - **ধাপ ৫:** মাঠপর্যায়ের ইঞ্জিনিয়ারিং গ্যাং-এর কাছে তাৎক্ষণিক SMS নোটিফিকেশন পৌঁছে যাওয়ার লাইভ অডিট ট্রেইল প্রদর্শন করুন।

---

## ৪৯. ইউজার টেস্টিং গাইড: প্রেজেন্টেশন সিনারিও D "Zero-Fatality Digital Safety Protocol" (`TSK-FINAL-04`) ✅ **[VERIFIED & TESTED]**

### ৪৯.১ সিনারিওর মূল উদ্দেশ্য ও বিচারকদের সামনে উপস্থাপনার রূপরেখা
ভারতীয় রেলওয়েতে ট্র্যাক কর্মীদের জীবন রক্ষা করা এবং অপারেশনাল ডিসিপ্লিনের জন্য প্ল্যাটফর্মের সবচেয়ে মর্যাদাপূর্ণ সুরক্ষা উদ্ভাবন হলো **Zero-Fatality Cyber-Physical Safety Protocol**:
১. **ক্রিপ্টোগ্রাফিক ডিজিটাল সেফটি টোকেন ইস্যু (#৭১):**
   - চিফ কন্ট্রোলার পজেশন সক্রিয় করামাত্রই ফিল্ড ট্র্যাক ইঞ্জিনিয়ারের ট্যাবলেটে SHA-256 হ্যান্ডশেকের মাধ্যমে অনন্য ডিজিটাল সেফটি টোকেন (`TOK-BL-20260920-7F8E-ACD9`) ইস্যু হয়।
২. **বায়োমেট্রিক হেডকাউন্ট ও RFID টুল রিকনসিলিয়েশন (#৭২):**
   - ডিজিটাল মাস্টার রোলে ১২ জন ট্র্যাকম্যানের বায়োমেট্রিক চেক-ইন এবং ২৪টি হাইড্রোলিক ট্র্যাক জ্যাক, রেল টংস ও টর্ক রেঞ্চের RFID স্ক্যান সম্পন্ন হয়। GPS জিওফেন্সিং (KM 14.2 থেকে 18.5) সক্রিয় হয়।
৩. **২৫kV OHE পাওয়ার আইসোলেশন ও LOTO ইন্টারলক (#৭৩):**
   - TRD কন্ট্রোল সেন্টার থেকে SCADA ফিডার ব্রেকার `CB-NDLS-04` ট্রিপ করানো হয় এবং ভোল্টেজ ০.০ kV-তে নেমে আসে। ফিজিক্যাল লকআউট-ট্যাগআউট (LOTO) কি `LOTO-TRD-NDLS-88` ইন্টারলক নিশ্চিত করে ডেড-সেকশন তৈরি করা হয়।
৪. **জিওট্যাগড ট্রু-ক্লিয়ারেন্স ফটো ভেরিফিকেশন (#৭৪):**
   - কাজ শেষ হওয়ার পর ফিল্ড সুপারভাইজার KM 16.350-এ EXIF জিপিএস সমন্বিত লাইভ ক্লিয়ারেন্স ছবি আপলোড করেন। এআই ভিশন এবং ক্রিপ্টোগ্রাফিক হ্যাশ নিশ্চিত করে যে ১২/১২ জন কর্মী এবং ২৪/২৪টি ভারী যন্ত্রপাতি সম্পূর্ণভাবে ট্র্যাকের বাইরে নিরাপদে সরে গেছে।
৫. **ডিজিটাল সেফটি সার্টিফিকেট ও ট্র্যাক হ্যান্ডব্যাক (#৮০):**
   - প্ল্যাটফর্ম স্বয়ংক্রিয়ভাবে ডিজিটাল হ্যান্ডব্যাক সার্টিফিকেট `CERT-SAFE-2026-0920-DLI-01` ইস্যু করে, SCADA ২৫kV পাওয়ার পুনরুদ্ধার করে এবং ৩D GIS রাডারে ট্র্যাকের রঙ উজ্জ্বল সবুজ হয়ে পূর্ণ ১৩০ কিমি/ঘণ্টা গতিতে ট্রেন চলাচলের অনুমতি ফিরে আসে।

---

### ৪৯.২ স্বয়ংক্রিয় এন্ড-টু-এন্ড টেস্ট চালান (Automated Verification)

টার্মিনাল বা PowerShell থেকে নিচের সহজ কমান্ডটি চালান:

```powershell
python scripts/test_final_04.py
```

#### টেস্ট স্ক্রিপ্ট যেভাবে ৮টি ধাপ স্বয়ংক্রিয়ভাবে যাচাই করে:
1. **ধাপ ১ (Chief Controller Authentication):** চিফ কন্ট্রোলারের সেন্ট্রাল কমান্ড অথরিটি নিশ্চিতকরণ।
2. **ধাপ ২ (Scenario D REST Execution):** `POST /api/v1/demo/scenarios/run/` এর মাধ্যমে সিনারিওর ৫টি সাইবার-ফিজিক্যাল সেফটি স্টেপ সম্পাদন।
3. **ধাপ ৩ (Cryptographic Safety Token #71):** ট্যাবলেটে প্রেরিত SHA-256 সেফটি টোকেন ও পজেশন অ্যাক্টিভেশন যাচাই।
4. **ধাপ ৪ (Biometric Muster & RFID Tools #72):** ১২/১২ জন কর্মী ও ২৪/২৪টি টুলের জিওফেন্স উপস্থিতি পরীক্ষা।
5. **ধাপ ৫ (25kV OHE LOTO Isolation #73):** SCADA ব্রেকার ওপেন (০.০ kV) ও LOTO ইন্টারলক কি যাচাই।
6. **ধাপ ৬ (Geotagged Clearance Photo #74):** EXIF জিপিএস ক্লিয়ারেন্স ফটো ও ক্রিপ্টোগ্রাফিক সিলমোহর অডিট।
7. **ধাপ ৭ (Safety Handback Certificate #80 & DB Status):** ডাটাবেজে `BLK-SAF-01` এর স্ট্যাটাস `COMPLETED`, `track_fit_certified=True` এবং ২৫kV বিদ্যুৎ পুনঃস্থাপন যাচাই।
8. **ধাপ ৮ (Frontend Modal Contract Audit):** `ScenarioPlayerModal.tsx`-এ পার্পল ব্যাজ ও জিরো-ফ্যাটালিটি প্রোটোকল ইন্টারফেস অডিট।

---

### ৪৯.৩ ওয়েব ব্রাউজারে বিচারকদের সামনে লাইভ ডেমো উপস্থাপনার নিয়ম (Presentation Flow)

১. **চিফ কন্ট্রোলার হিসেবে লগইন করুন:**
   - ব্রাউজারে যান: `http://localhost:3000/login`
   - ইউজারনেম: `coa_delhi_chief` | পাসওয়ার্ড: `railway@123`
২. **সিনারিও প্লেয়ার চালু করুন:**
   - হেডারে **🎬 চিত্রনাট্য প্লেয়ার** বাটনে ক্লিক করুন।
   - **"Scenario D: Digital Safety"** (ট্যাগ: *Zero-Fatality Protocol*) সিলেক্ট করে **"Play Scenario"** বাটনে ক্লিক করুন।
৩. **ধাপ ৩, ৪ ও ৫-এ বিশেষ নজর দিন:**
   - **ধাপ ৩:** SCADA ব্রেকার ট্রিপ এবং LOTO কী-এর মাধ্যমে ২৫kV বিদ্যুৎ সম্পূর্ণ বন্ধ হওয়ার প্রমাণপত্র তুলে ধরুন।
   - **ধাপ ৪:** কাজ শেষে মাঠ থেকে আপলোড করা জিপিএস জিওট্যাগড ছবির হ্যাশ এবং শতভাগ কর্মী ও টুলের ট্র্যাক ত্যাগের এআই প্রমাণপত্র দেখান।
   - **ধাপ ৫:** ডিজিটাল সার্টিফিকেট ইস্যুর পর স্ক্রিনে ট্র্যাকের রঙ লাল/হলুদ থেকে উজ্জ্বল সবুজ (GREEN) হয়ে ওঠা এবং ১৩০ কিমি/ঘণ্টা লাইন স্পিড পুনরুদ্ধারের দৃশ্য প্রদর্শন করুন।

---

## ৫০. ইউজার টেস্টিং গাইড: ওয়ালবোর্ড প্রেজেন্টেশন মোড ও কন্টিনিউয়াস লাইভ স্ট্রিমিং (`TSK-FINAL-05`) ✅ **[VERIFIED & TESTED]**

### ৫০.১ ফিচারের মূল উদ্দেশ্য ও অপারেশনস থিয়েটার ভিডিও ওয়াল ডিসপ্লে
স্মার্ট ইন্ডিয়া হ্যাকাথনের গ্র্যান্ড ফিনালেতে বিচারক ও উচ্চপদস্থ রেলওয়ে কর্মকর্তাদের সামনে প্রদর্শনের জন্য সম্পূর্ণ স্ক্রিনজুড়ে ৪K আল্ট্রা এইচডি সাইবার-রেলওয়ে ওয়ালবোর্ড মোড (`/bigscreen`) প্রস্তুত করা হয়েছে:
১. **৪টি এক্সিকিউটিভ OLAP KPI কাউন্টার:**
   - **Corridor Punctuality (৯৬.৫%):** লাইভ সময়ানুবর্তিতা এবং অন-টাইম বনাম নিয়ন্ত্রিত ট্রেনের অনুপাত।
   - **Possession Utilization (৫৬.৯% - ৯৪.২%):** ট্র্যাকে কার্যকর কাজের সময়।
   - **Shadow Block Bundling Ratio (১৬.৫% - ২০.০%):** এআই কম্বাইন্ড ব্লকের মাধ্যমে সাশ্রয়কৃত সময়।
   - **Track Quality Index (২৫.০৯):** RDSO TRC স্ট্যান্ডার্ড অনুযায়ী ট্র্যাকের সার্বিক সুরক্ষা ও হেলথ গ্রেড (`GOOD`)।
২. **প্যানোরামিক মাল্টি-মনিটর লেআউট (৩ কলাম):**
   - **বাম কলাম:** লাইভ ট্র্যাক পজেশন তালিকা এবং চলমান ব্লকের কাউন্টডাউন।
   - **মাঝের কলাম:** ৩D GIS রাডার ট্র্যাক প্রজেকশন এবং ৭ দিনের ঐতিহাসিক ট্রেন্ড বার চার্ট।
   - **ডান কলাম:** উত্তর রেলওয়ের ৯টি করিডোরের তুলনামূলক র্যাঙ্কিং এবং ডিসক্রিপশন লজিক সেফটি ইনভেরিয়েন্ট স্ট্যাটাস।
৩. **কন্টিনিউয়াস লাইভ স্ট্রিমিং (`stream_demo_data`):**
   - ড্যাফনে (Daphne Channels) এবং রেডিস পাব/সাব চ্যানেলের মাধ্যমে ব্রাউজার রিলোড ছাড়াই প্রতি সেকেন্ডে ৪Hz গতিতে লাইভ ট্রেনের জিপিএস অবস্থান, ডিফেক্ট অ্যালার্ট ও হার্টবিট ডাটা স্ক্রিনে স্পন্দিত হয়।
৪. **অন-ডিমান্ড OLAP ও রিপোর্টল্যাব PDF ডাউনলোড:**
   - স্ক্রিনে থাকা **"RECALCULATE OLAP"** বাটনে ক্লিক করলে পেজ রিফ্রেশ ছাড়াই ব্যাকএন্ডে মুহূর্তের মধ্যে হিসাব আপডেট হয়।
   - **"CORRIDOR REPORT (PDF)"** বাটনে এক ক্লিকে অফিশিয়াল ডিজিটাল সিলমোহর ও SHA-256 টোকেন সহ করিডোর বুলেটিন ডাউনলোড হয়।

---

### ৫০.২ স্বয়ংক্রিয় এন্ড-টু-এন্ড টেস্ট চালান (Automated Verification)

টার্মিনাল বা PowerShell থেকে নিচের কমান্ডটি চালান:

```powershell
python scripts/test_final_05.py
```

#### টেস্ট স্ক্রিপ্ট যেভাবে ৯টি ধাপ স্বয়ংক্রিয়ভাবে যাচাই করে:
1. **ধাপ ১ (Chief Controller Authentication):** সেন্ট্রাল কমান্ড অথরিটি ও JWT টোকেন সংগ্রহ।
2. **ধাপ ২ (Wallboard Frontend Route):** `http://localhost:3000/bigscreen` রাউট ও `BigScreenMode.tsx` কম্পোনেন্টের সত্যতা যাচাই।
3. **ধাপ ৩ (Executive OLAP KPI Counters):** ডাটাবেজ থেকে ৪টি মূল এক্সিকিউটিভ কার্ড ডেটা রিয়েল-টাইমে পড়া।
4. **ধাপ ৪ (Multi-Corridor Comparative Benchmarks):** করিডোর তুলনামূলক র্যাঙ্কিং টেবিল পরীক্ষা।
5. **ধাপ ৫ (Live Possessions & 3D Train Radar):** লাইভ ব্লক ও ১২টি ট্রেনের ট্র্যাকিং ডেটা যাচাই।
6. **ধাপ ৬ (Daphne WebSocket Continuous Streaming):** `stream_demo_data` চালিয়ে ড্যাফনে ওয়েবসকেটের মাধ্যমে রিয়েল-টাইমে ৪টি লাইভ ইভেন্ট ফ্রেম গ্রহণ ও যাচাই।
7. **ধাপ ৭ (On-Demand OLAP Recalculation):** `POST /api/v1/analytics/kpi/recalculate/` কল করে তাৎক্ষণিক ডেটা রিক্যালকুলেশন পরীক্ষা।
8. **ধাপ ৮ (Official PDF Corridor Report Download):** ৪,২০৯ বাইটের অফিশিয়াল রিপোর্টল্যাব PDF ডাউনলোড ও ম্যাজিক বাইট `%PDF` যাচাই।
9. **ধাপ ৯ (1080p Full HD & 4K Ultra HD Display Optimizations):** সিএসএস গ্রিড ও ডার্ক HUD থিম অডিট।

---

### ৫০.৩ গ্র্যান্ড ফিনালে লাইভ ডেমো উপস্থাপনার নিয়ম (Presentation Flow)

১. **চিফ কন্ট্রোলার হিসেবে লগইন করুন:**
   - ব্রাউজারে যান: `http://localhost:3000/login`
   - ইউজারনেম: `coa_delhi_chief` | পাসওয়ার্ড: `railway@123`
২. **ওয়ালবোর্ড মোডে যান:**
   - সরাসরি ভিজিট করুন: `http://localhost:3000/bigscreen`
   - অথবা কন্ট্রোল রুমের উপরে ডানদিকের মনিটর আইকনে ক্লিক করুন।
৩. **৪K ফুলস্ক্রিন চালু করুন:**
   - কীবোর্ডের `F11` চাপুন অথবা স্ক্রিনের শীর্ষে থাকা ফুলস্ক্রিন আইকনে ক্লিক করুন।
৪. **ব্যাকগ্রাউন্ডে লাইভ স্ট্রিমিং চালু করুন:**
   - টার্মিনালে কমান্ডটি চালিয়ে দিন যাতে স্ক্রিনে সংখ্যা ও ট্রেনের পজিশন নিজে থেকেই স্পন্দিত হতে থাকে:
   ```powershell
   docker exec railway_backend python manage.py stream_demo_data --rate 4.0 --duration 1800 --broadcast
   ```
৫. **অফিশিয়াল রিপোর্ট ডাউনলোড করে বিচারকদের দেখান:**
   - স্ক্রিনের শীর্ষে থাকা **"CORRIDOR REPORT (PDF)"** বাটনে ক্লিক করুন এবং সাথে সাথে ওপেন করে ভারতীয় রেলওয়ের অফিশিয়াল ডিজিটাল সিলমোহর যুক্ত ৩ পাতার রিপোর্টটি বিচারকদের সামনে প্রদর্শন করুন!
